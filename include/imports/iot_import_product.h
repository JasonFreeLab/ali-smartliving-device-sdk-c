 ...
 */
DLL_HAL_API int HAL_GetFirmwareVersion(_OU_ char *version);
 ...
 */
DLL_HAL_API int HAL_GetPartnerID(_OU_ char *pid_str);
 ...
 */
DLL_HAL_API int HAL_GetModuleID(_OU_ char *mid_str);
 ...
 */
DLL_HAL_API int HAL_GetDeviceID(_OU_ char *device_id);
 ...
 * @return  写到product_key[]数组中的字符长度, 单位是字节(Byte)
 */
DLL_HAL_API int HAL_GetProductKey(_OU_ char *product_key);
 ...
 * @return  写到device_name[]数组中的字符长度, 单位是字节(Byte)
 */
DLL_HAL_API int HAL_GetDeviceName(_OU_ char *device_name);
 ...
 * @return  写到device_secret[]数组中的字符长度, 单位是字节(Byte)
 */
DLL_HAL_API int HAL_GetDeviceSecret(_OU_ char *device_secret);
 ...
 * @return  写到product_secret[]数组中的字符长度, 单位是字节(Byte)
 */
DLL_HAL_API int HAL_GetProductSecret(_OU_ char *product_secret);
